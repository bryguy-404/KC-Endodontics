# Build the KC Endodontics homepage — Phase 2 (Design)

You are Claude Code running inside Cursor. The scaffolded Astro project for **KC Endodontics** is open as the workspace, and the design hand-off files are already in this workspace.
...
The slugified project name is `kc-endodontics`.
